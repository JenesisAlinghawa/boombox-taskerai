...
export default function TaskToolbar({
  ...
  return (
    <div className="flex items-center gap-3 mb-5">
      {/* Search Bar */}
      <div className="flex items-center gap-15 px-[18px] py-2 rounded-full bg-blue-500/15">
      ...
      <div className="flex gap-2">
        ...
        <select
          ...
          className="px-2.5 py-1 rounded-lg bg-blue-500/25 text-white text-sm cursor-pointer"
        >
        ...
        <button
          ...
          className="p-2 rounded-lg bg-transparent text-white cursor-pointer text-xs font-normal hover:bg-white/10 transition-colors"
        >
